...
const PurchaseOrder: React.FC<PurchaseOrderProps> = ({ order, customers, crops, farmInfo }) => {
            ...
            <div className="p-8 font-sans">
                ...
                <div className="flex justify-between items-start mb-8 border-b pb-4">
                    ...
                    <div className="text-right">
                        <h2 className="text-3xl font-bold text-gray-800">ใบสั่งซื้อ / Purchase Order</h2>
                        <p className="text-gray-600">เลขที่: PO-{String(order.id).padStart(5, '0')}</p>
                ...
                {/* Customer Info */}
                <div className="mb-8">
                    <h3 className="text-lg font-semibold text-gray-700 mb-2">ข้อมูลลูกค้า / Bill To</h3>
                    {customer ? (
                ...
                <div className="mt-16 text-center text-xs text-gray-500 border-t pt-4">
                    <p>ขอขอบคุณสำหรับการสั่งซื้อสินค้ากับ Smile Farm</p>
                </div>
            </div>
        </div>
    );
